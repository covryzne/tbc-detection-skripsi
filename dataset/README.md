...
Untuk menyeimbangkan distribusi kelas, dilakukan **undersampling** pada kelas _Normal_ sehingga masing-masing kelas memiliki 3194 gambar sebelum proses pelatihan.
...
> _"Reliable Tuberculosis Detection using Chest X-ray with Deep Learning, Segmentation and Visualization"_.  
...
> _"Tuberculosis Chest X-ray Image Dataset"_.  
...
Agar dataset menjadi seimbang dan menghindari bias terhadap kelas mayoritas, dilakukan **undersampling** terhadap kelas _Normal_ secara acak, sehingga jumlah akhir menjadi:
