      ...
      >
        {path ? (
          <div className="flex flex-col space-y-2">
            <h3 className="text-center text-primary">Image Preview</h3>
            <div className="flex w-64 h-60 relative">
              <Image
          ...
          <label
            id="label"
            className="w-64 h-48 justify-center flex flex-col items-center px-4 py-6 bg-white rounded-md shadow-md tracking-wide border border-sky cursor-pointer hover:bg-primary hover:text-white text-primary ease-linear transition-all duration-150"
          >
            <svg
              className="w-10 h-10"
              fill="currentColor"
        ...
        {results ? (
          <div className="flex flex-col space-y-4">
            <div className="flex flex-col text-center space-y-1">
              <h4 className="font-bold text-primary py-1">
                Prediction Results
              </h4>
              <p>
